...
export default function GoalBar({ goal, currentGoal, setCurrentGoal, deleteGoal, setSubmitError }) {
  ...
  function handleGoalBarClick(goal) {
  ...
  return (
    <>
      <div className="article-container mx-4 d-flex">
        <button className="btn btn-secondary mt-3 w-100 d-flex justify-content-between align-items-center" type="button" onClick={() => handleGoalBarClick(goal)}>
          <span>{goal.name}</span>
