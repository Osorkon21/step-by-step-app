  ...
  return (
    <div className="stepBarOpen curent_step_open truncate flex flex-col gap-1 cursor-pointer w-full" onClick={handleStepBarClick}>
      <div className="w-full">
        <textarea ref={titleRef} data-uuid={step.uuid} className={`w-full shadow-custom border-2 border-transparent p-2 pl-4 overflow-y-hidden focus:bg-white hover:bg-white focus:outline-middleblur bg-lightgray focus:shadow-none`} name="title" value={step.title} placeholder="Step title" onChange={handleInputChange} />
      </div>
