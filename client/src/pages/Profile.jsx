...
export default function Profile() {
  ...
  return (
    <div className="profile body text-purple text-center bg-middleblur h-screen">
      <h1 className="text-5xl md:text-6xl my-8">User Profile</h1>

      {appCtx.user?._id !== undefined && (
        <form className="grid sm:grid-cols-2 gap-8  justify-center" onSubmit={handleSubmit}>
          ...
          <div className="column-2">
            ...
            <div className="gap-2 flex flex-col">
              ...
              <Select className="" placeholder={userData.pronouns || "Choose Pronouns"} aria-label="pronoun select dropdown" onSelectionChange={handleSelect}>
                <Button className="p-2 border-2 border-purple bg-middle">
                  <SelectValue />
          ...
          <button className="update-goal-btn " type="submit">Save Changes</button>
